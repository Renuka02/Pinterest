...
public class DisplayBoardPins extends ActionBarActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.user) {
            startActivity(new Intent(DisplayBoardPins.this,User_Details.class));
            return true;
        }

        if (id == R.id.search) {
            startActivity(new Intent(DisplayBoardPins.this,Search.class));
            return true;
        }
    ...
    class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.HomeListHolder>{
        ...
        public void onBindViewHolder(HomeListHolder holder, int position) {
            ...
            Picasso.with(DisplayBoardPins.this).load(url).into(holder.iv);
        }
        ...
        class HomeListHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                edt.commit();
                startActivity(new Intent(DisplayBoardPins.this, Pin.class));
            }
        }
    ...
    class GetAllPins extends AsyncTask<String,Integer,String>{
        ...
        HttpPost get = new HttpPost("http://pintrestproj.net46.net/getboardpins.php");
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd = new ProgressDialog(DisplayBoardPins.this);
        ...
        protected void onPostExecute(String s) {
            ...
            pd.dismiss();
            if (count>0){
                adapter = new HomeListAdapter(DisplayBoardPins.this, senddata());
                rv.setAdapter(adapter);
                rv.setLayoutManager(new GridLayoutManager(DisplayBoardPins.this,2));
            }else{
                Toast.makeText(DisplayBoardPins.this,"Error getting pins.",Toast.LENGTH_SHORT).show();
