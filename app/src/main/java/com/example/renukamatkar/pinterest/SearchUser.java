...
public class SearchUser extends ActionBarActivity {
    ...
    class SearchPin extends AsyncTask<String,Integer,String>{
        ...
        HttpPost post = new HttpPost("http://pintrestproj.net46.net/searchuser.php");
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                for(int i =0;i<ja.length();i++){
                    ...
                    searchresult[i] = jo.getString("name");
                }
            } catch (IOException e) {
                e.printStackTrace();
        ...
        protected void onPostExecute(String s) {
            ...
            if(searchresult.length>0){
                ...
                searchadapter = new ArrayAdapter<String>(SearchUser.this,android.R.layout.simple_list_item_1,searchlist);
                etsearch.setAdapter(searchadapter);
                searchadapter.notifyDataSetChanged();
            }else{
                searchresult= new String[0];
                searchlist = new ArrayList<>();
                searchadapter = new ArrayAdapter<String>(SearchUser.this,android.R.layout.simple_list_item_1,searchresult);
                searchadapter.notifyDataSetChanged();
            }
        }
    }
    ...
    class AllocPins extends AsyncTask<String,Integer,String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pdd = new ProgressDialog(SearchUser.this);
        ...
        @Override
        protected String doInBackground(String... strings) {
            entity.addPart("name",etsearch.getText().toString());
            post.setEntity(entity);
        ...
        protected void onPostExecute(String s) {
            ...
            if (count>0){
                ...
                adapter = new HomeListAdapter(SearchUser.this, senddata());
                rv.setAdapter(adapter);
                rv.setLayoutManager(new GridLayoutManager(SearchUser.this,2));
            }else{
                Toast.makeText(SearchUser.this, "Error getting users.", Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    class HomeListAdapter extends RecyclerView.Adapter<HomeListAdapter.HomeListHolder>{
        ...
        public void onBindViewHolder(HomeListHolder holder, int position) {
            ...
            Picasso.with(SearchUser.this).load(url).into(holder.iv);
        }
        ...
        class HomeListHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
            ...
            public void onClick(View view) {
                ...
                edt.putString("clickeduserid",pos);
                edt.commit();
                startActivity(new Intent(SearchUser.this, ClickedUserDetails.class));
            }
        }
