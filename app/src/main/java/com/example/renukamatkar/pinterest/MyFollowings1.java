 ...
 */
public class MyFollowings1 extends Fragment {
    ...
    class GetBoards extends AsyncTask<String,Integer,String>{
        ...
        ProgressDialog pd;
        HttpClient client = new DefaultHttpClient();
        HttpPost post = new HttpPost("http://pintrestproj.net46.net/getfollowing.php");
        MultipartEntity entity = new MultipartEntity();
        ...
        protected String doInBackground(String... strings) {
            try {
                entity.addPart("followerid",sp.getString("clickeduserid","-1"));
                post.setEntity(entity);
                response = client.execute(post);
                result = EntityUtils.toString(response.getEntity());
        ...
        protected void onPostExecute(String s) {
            ...
            if(count>0){
                ...
                cboard.setText(count+" Following(s) found");
            }else{
                cboard.setText("No Following(s) found");
